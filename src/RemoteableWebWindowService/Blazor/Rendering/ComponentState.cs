...
using PeakSwc.Components.RenderTree;

namespace PeakSwc.Components.Rendering
{
    /// <summary>
    ...
    internal class ComponentState : IDisposable
    {
        ...
        private ArrayBuilder<RenderTree.RenderTreeFrame> _latestDirectParametersSnapshot; // Lazily instantiated
