...
using PeakSwc.Components.Server;
using PeakSwc.Components.Server.BlazorPack;
...
namespace PeakSwc.Extensions.DependencyInjection
{
    ...
    public static class ComponentServiceCollectionExtensions
    {
        ...
        public static IServerSideBlazorBuilder AddPeakSwcServerSideBlazor(this IServiceCollection services, Action<CircuitOptions> configure = null)
        {
            ...
            // TODO services.AddScoped<AuthenticationStateProvider, ServerAuthenticationStateProvider>();
